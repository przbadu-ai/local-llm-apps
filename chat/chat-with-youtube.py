...
st.set_page_config(page_title="YouTube Video Chat Bot", page_icon="📺", layout="wide")

st.title("Chat with YouTube Video 📺")
st.caption(
    "This app allows you to chat with a YouTube video using Ollama (llama3:instruct)"
)
...
if "db_path" not in st.session_state:
    ...
    st.session_state.app = llm_config.create_bot(
        st.session_state.db_path, openai_access_token
    )
